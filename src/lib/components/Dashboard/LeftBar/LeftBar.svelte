<script>
    ...
    import Schedule from "../Views/Schedule/Index.svelte";
    import Progress from "../Views/Progress/Index.svelte";
    import Students from "../Views/Students/Index.svelte";
    import Teachers from "../Views/Teachers/Index.svelte";

    import QuranFlow from "../Views/QuranFlow/Index.svelte";
    import BibleFlow from "../Views/BibleFlow/Index.svelte";
    import SeerahFlow from "../Views/SeerahFlow/Index.svelte";

    import Availability from "../Views/Availability/Index.svelte";
    import SessionsPlanner from "../Views/SessionsPlanner/Index.svelte";
    import Profile from "../Views/Profile/Index.svelte";
            ...
            <div class="sections">
                <nav>
                    <div class="buttons">
                        <div class="expand">
                            <div class="button">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24px" height="24px" fill="#A0A4AC" viewBox="0 0 256 256"><path d="M141.66,133.66l-80,80a8,8,0,0,1-11.32-11.32L124.69,128,50.34,53.66A8,8,0,0,1,61.66,42.34l80,80A8,8,0,0,1,141.66,133.66Zm80-11.32-80-80a8,8,0,0,0-11.32,11.32L204.69,128l-74.35,74.34a8,8,0,0,0,11.32,11.32l80-80A8,8,0,0,0,221.66,122.34Z"></path></svg>
                            </div>
                        </div>
                        ...
                        {#each ($user && $user.admin ? adminButtons : buttons) || [] as button}
                            {#if button.divider}
                                <hr>
                            {:else}
                                <a href="" on:click={() => selectTab(button.component)}  class:selected={button.component === selectedTab}>
                                    <div class="button">
                                        {#if button.svg}
                                            {@html button.svg}
                                        {:else if button.img}
