<script>
	...
	onMount(async () => {
        segments = await API.get(`/quranflow/slides/${$page.params.verses}.json`)
...
.summary::-webkit-scrollbar, .verses::-webkit-scrollbar,  .hide-small::-webkit-scrollbar {
  display: none;
}

/* Hide scrollbar for IE, Edge and Firefox */
.summary, .verses, .hide-small {
